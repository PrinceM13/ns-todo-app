  ...
  return (
    <PrivateRoute>
      <div className="h-screen flex flex-col">
        <div className="min-h-[60px] flex justify-between items-center px-8 py-2 border-b-2 border-b-neutral-300 bg-gradient-to-r from-[#57bce3] via-[#83d1da] to-[#cdd8d4]">
